...
void  OptReaction::updateJacobian32
(
...
)const noexcept
{
    ...
    {
        const unsigned int i = this->reaction32index[k];
        ...
        if(this->isIrreversible[i]==0)
        {
            ...
            dKrdT = (dKfdT/Kc - (Kc > KcLimiter ? Kr*dKcdTByKc : 0));  
...
)const noexcept
{
    ...
    for(std::size_t k=0; k<end; k++)
    {
        const unsigned int i = this->reversibleReaction32index[k];

 
        const unsigned int sl0 = this->lhsSpeciesIndex1D32RR[lhsIndex+0];
        const unsigned int sl1 = this->lhsSpeciesIndex1D32RR[lhsIndex+1];
        const unsigned int sl2 = this->lhsSpeciesIndex1D32RR[lhsIndex+2];

        const unsigned int sr0 = this->rhsSpeciesIndex1D32RR[rhsIndex+0];
        const unsigned int sr1 = this->rhsSpeciesIndex1D32RR[rhsIndex+1];
        ...
        const double invKp = (invNegGstdByRT[sr0]*invNegGstdByRT[sr1])*
            (ExpNegGbyRT[sl0]*ExpNegGbyRT[sl1]*ExpNegGbyRT[sl2]);
        invKc = invKp*this->Pow_pByRT_SumVki[3];
...
)const noexcept
{
    ...
    for(std::size_t k=0; k<end; k++)
    {
        const unsigned int i = this->irreversibleReaction32index[k];

 
        const unsigned int sl0 = this->lhsSpeciesIndex1D32IR[lhsIndex+0];
        const unsigned int sl1 = this->lhsSpeciesIndex1D32IR[lhsIndex+1];
        const unsigned int sl2 = this->lhsSpeciesIndex1D32IR[lhsIndex+2];

        const unsigned int sr0 = this->rhsSpeciesIndex1D32IR[rhsIndex+0];
        const unsigned int sr1 = this->rhsSpeciesIndex1D32IR[rhsIndex+1];
...
)const noexcept
{
    ...
    for(std::size_t k=0; k<end; k++)
    {
        const unsigned int i = this->nonEquilibriumReaction32index[k];

 
        const unsigned int sl0 = lhsSpeciesIndex1D32NER[lhsIndex+0];
        const unsigned int sl1 = lhsSpeciesIndex1D32NER[lhsIndex+1];
        const unsigned int sl2 = lhsSpeciesIndex1D32NER[lhsIndex+2];

        const unsigned int sr0 = rhsSpeciesIndex1D32NER[rhsIndex+0];
        const unsigned int sr1 = rhsSpeciesIndex1D32NER[rhsIndex+1];
