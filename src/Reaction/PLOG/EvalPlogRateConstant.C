...
void FastChemistry::OptReaction::evalPlogRateConstant()const noexcept
{
    ...
    else if(remain==3)
    {
        ...
        //double weight3 = (this->logP - this->logPi[j3][index3])*this->rDeltaP_[j3][index3];
        //double Kf03 = this->Kf_[j3+this->Ikf[6]];
       // double Kf13 = this->Kf_[j3+this->Ikf[11]];
        //double logA1A03 = this->logAPlog[j3][index3+1] - this->logAPlog[j3][index3];
        //double beta1beta03 = this->betaPlog[j3][index3+1] - this->betaPlog[j3][index3];
        //double Ta0Ta13 = this->TaPlog[j3][index3] - this->TaPlog[j3][index3+1];
        //double logk1k03 = logA1A03 + beta1beta03*logT_ + Ta0Ta13*invT_;
        //double k3 = Kf03*std::exp(weight3*logk1k03);
        //this->Kf_[j3+this->Ikf[6]] = k3;
